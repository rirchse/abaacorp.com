...
<div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="<?php echo e(route('portfolio.create')); ?>" class="nav-link text-white">
          <i class="fa fa-pen"></i> Create Portfolio
        </a>
      </li>
      <li>
        <a href="<?php echo e(route('portfolio.index')); ?>" class="nav-link text-white">
...
</div><?php /**PATH /srv/www/solutiongrid/resources/views/dashboard/sidebar.blade.php ENDPATH**/ ?>