        ...
        <div class="row d-flex align-items-center">
            <div class="col-lg-6 col-md-7 col-sm-7 text-sm-start text-center wow fadeInLeft" data-wow-delay="300ms">
                <div class="heading-title mb-4">
                    <h2 class="darkcolor font-normal bottom30"> About <span class="defaultcolor"> Us</span></h2>
                </div>
                <p class="bottom35">We are a group of passionate professionals who always adopt result-oriented and innovative techniques to the core that help in enhancing your business through information technology.</p>
                <p class="bottom35">We are best known for quality Software Development, Mobile App Development, Website Design and Development, Graphics, Animation & Motion Graphics as well as Digital Marketing Services along with Search Engine Optimization.</p>
            </div>
            <div class="col-lg-5 offset-lg-1 col-md-5 col-sm-5 wow fadeInRight" data-wow-delay="300ms">
                <div class="image"><img alt="SEO" src="images/about.png"></div>
            </div>
        </div>
    </div>
</section>
<!--Some Feature ends-->
<!-- WOrk Process-->
<section id="our-process" class="padding" style="background:url('/images/testimonial-bg.jpg');">
    <div class="container" style="background-color:rgba(0,0,0,0.5);padding:30px 20px">
        <div class="row">
...
<!--WOrk Process ends-->
<!-- Our Blogs -->  
<section id="services" class="bglight padding">
    <div class="container">
...
<?php echo $__env->make('home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/www/abaacorp/resources/views/home/index.blade.php ENDPATH**/ ?>